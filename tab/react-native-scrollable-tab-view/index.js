...
const AnimatedViewPagerAndroid = undefined;
...
const ScrollableTabView = createReactClass({
  ...
  renderScrollableContent() {
    ...
    if (Platform.OS === 'ios') {
      ...
      // return (
      //   <ScrollTest initialPage={this.props.initialPage} 
      //               containerWidth={this.state.containerWidth}
      //               scrollXIOS={this.state.scrollXIOS}
      //               scrollRef={this.scrollView}
      //               _onScroll={this._onScroll}
      //               _onMomentumScrollBeginAndEnd={this._onMomentumScrollBeginAndEnd}
